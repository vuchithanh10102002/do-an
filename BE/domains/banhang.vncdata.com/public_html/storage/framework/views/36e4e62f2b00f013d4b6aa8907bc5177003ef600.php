...
<div class="view" xmlns="http://www.w3.org/1999/html">
    ...
    <div id="content-table" style="float: left;width: calc(100% - 370px);">
        <div class="input-product-top">
            ...
            <?php /*<input class="im-expiry_at" id="expiry_at">*/ ?>
            <?php /*<button style="margin: 10px 0;display: inline-block;float: right;border-radius: 0;" id="btn_print_qr"><i*/ ?>
                        <?php /*class="fa fa-qrcode"></i> In mã*/ ?>
            <?php /*</button>*/ ?>
        </div>
        <div id="table"></div>
    </div>
