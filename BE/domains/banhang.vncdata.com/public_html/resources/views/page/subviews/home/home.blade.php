    ...
    <div class="clearfix">
        <div class="box">
            ...
            <div class="box-content">
                <p class="box-title">@lang('lang.All products')</p>
        ...
        <div class="box">
            ...
            <div class="box-content">
                <p class="box-title">@lang('lang.Sales today')</p>
        ...
        <div class="box">
            ...
            <div class="box-content">
                <p class="box-title">@lang('lang.Money imported today')</p>
        ...
        <div class="box">
            ...
            <div class="box-content">
                <p class="box-title">@lang('lang.Interest today')</p>
        ...
        <div class="box">
            ...
            <div class="box-content">
                <p class="box-title">@lang('lang.Payment today')</p>
