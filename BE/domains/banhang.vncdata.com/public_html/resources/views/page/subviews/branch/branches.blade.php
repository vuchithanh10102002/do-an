    ...
    <div>
        <div>
            ...
            <select id="state" class="select">
                <option value="{!! \App\CusstomPHP\State::$tt_Active !!}">{!! \App\CusstomPHP\State::getTxtState(\App\CusstomPHP\State::$tt_Active) !!}</option>
                <option value="{!! \App\CusstomPHP\State::$tt_Inactive !!}">{!! \App\CusstomPHP\State::getTxtState(\App\CusstomPHP\State::$tt_Inactive) !!}</option>
            </select>
            <label>Ghi chú:</label>
