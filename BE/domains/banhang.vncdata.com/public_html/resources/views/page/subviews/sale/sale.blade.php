<div class="view">
    <div id="sidebar" style="float: right;width: 26.5%;margin-left: 1%;margin-right: 0;">
        <div class="sidebar-item">
            <div>@lang('lang.Sales information')</div>
            <div>
                <div>
                ...
                <div style="margin-top: 10px;" class="div-sale clearfix">
                    <label class="lable_sale" for="Stienhang">@lang('lang.Total product money'):</label>
                    <input class="sale-input sale-input-green" id="Stienhang">
                </div>
                <div class="div-sale clearfix">
                    <label class="lable_sale" for="Skhuyenmai">@lang('lang.Promotion amount'):</label>
                    <input class="sale-input" style="border: 1px solid rgba(92, 184, 92,0.3);" id="Skhuyenmai">
                </div>
                <div class="div-sale clearfix">
                    <label class="lable_sale" for="Sthukhac">@lang('lang.Other receipts'):</label>
                    <input style="border: 1px solid rgba(92, 184, 92,0.3)" class="sale-input" id="Sthukhac">
                </div>
                <div class="div-sale clearfix">
                    <label class="lable_sale" for="Sthanhtoan">@lang('lang.Total payment'):</label>
                    <input class="sale-input" id="Sthanhtoan">
                </div>
                <div class="div-sale clearfix">
                    <label class="lable_sale" for="Skhachthanhtoan">@lang('lang.Customer paid'):</label>
                    <input style="border: 1px solid rgba(92, 184, 92,0.3)" class="sale-input sale-input-yellow" id="Skhachthanhtoan">
                </div>
                <div class="div-sale clearfix">
                    <label class="lable_sale" for="Snolai">@lang('lang.Customer debts'):</label>
                    <input class="sale-input" id="Snolai">
                </div>
                <div>
                    <label for="ghichu">@lang('lang.Note'):</label>
    ...
    <div id="content-table" style="float: left;width: 72%;">
        <div class="input-product-top">
            ...
            <div class="container-xx" style="margin-right: 0;float: right;">
                <button onclick="location.hash='';SaleApp.setup_custom(false);" id="btn_exit" style="">
                    <i class="fa fa-power-off"></i> @lang('lang.Exit')
                </button>
            </div>

            <div class="container-xx" style="margin-right: 0;float: right;">
                <button id="dongbo" style=""><i class="fa fa-cloud"></i> @lang('lang.Synchronous')</button>
            </div>

            <div class="container-xx" style="margin-right: 0;float: right;">
                <button id="trahang" style=""><i class="fa fa-undo"></i> @lang('lang.Product Returns')</button>
            </div>
            <div class="container-xx" style="margin-right: 0;float: right;">
                <button id="mayquet" style=""><i class="fa fa-keyboard-o"></i> @lang('lang.Keyboard')</button>
            </div>
            <div class="container-xx" style="margin-right: 0;float: right;">
                <button id="btn_clear" onclick="SaleApp.clear();" style="">
                    <i class="fa fa-refresh"></i> @lang('lang.Clean')
                </button>
            </div>
        </div>
        <div id="table"></div>
        ...
        <div class="grid-data-web">
            <div class="grid-data-web-title">
                <span id="btn-show-web"><i class="fa fa-chevron-down"></i> @lang('lang.Collapse')</span>
            </div>
    ...
    <div id="popthemkhachhang">
        <div>
            <span>@lang('lang.Customer information')</span>
        </div>
        <div>
            <div class="clearfix">
...
<script>
    ...
    SaleApp.createUI = function () {
        ...
        txt_timsanpham.jqxComboBox({
            ...
            placeHolder: "@lang('lang.Search for products')",
        ...
        txt_timkhachhang.jqxComboBox({
            ...
            showArrow: false,
            valueMember: 'code',
            placeHolder: "@lang('lang.Search for customers')",
            searchMode: 'containsignorecase',
            renderSelectedItem: function (index, item) {
                if (item['value'] !== '') {
        ...
        table.jqxGrid({
            ...
            columns: [
                ...
                {
                    text: '@lang('lang.Product code')',
                    dataField: 'code',
                    width: '120', editable: false
                }, {
                    text: '@lang('lang.Product name')',
                    dataField: 'name', editable: false
                }, {
                    text: '@lang('lang.Number')',
                    dataField: 'number',
    ...
    SaleApp.createEvent = function () {
            ...
            if (e.keyCode == 13) {
                if (txt_timsanpham.jqxComboBox('val').trim() != '') {
                    ...
                    if (sp != null) {
                        ...
                        app.notify('@lang('lang.Product not in stock!')', 'warning');
                        if (chedomayquet) {
        ...
        input_km.click(function () {
            ...
            popphantram.jqxPopover({
                ...
                width: 170,
                height: 80,
                'title': '@lang('lang.Enter percentage %'):',
                selector: $(this)
            });
        ...
        btn_mayquet.click(function () {
            if (chedomayquet) {
                ...
                btn_mayquet.html('<i class="fa fa-qrcode"></i> @lang('lang.Scanner')');
            } else {
                ...
                btn_mayquet.html('<i class="fa fa-keyboard-o"></i> @lang('lang.Keyboard')');
            }
            setTimeout(function () {
                txt_timsanpham.jqxComboBox('val', '');
                txt_timsanpham.jqxComboBox('focus');
