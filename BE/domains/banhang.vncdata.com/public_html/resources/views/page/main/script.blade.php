<script type="text/javascript">
    ...
    var urls = {
        urlviews: '{!! \App\CusstomPHP\CustomURL::route('view') !!}',
        url_apis: {
            product_logs: '{!! \App\CusstomPHP\CustomURL::routeApi('product-logs') !!}',
            product_list: '{!! \App\CusstomPHP\CustomURL::routeApi('product-list') !!}',
            product_move: '{!! \App\CusstomPHP\CustomURL::routeApi('product-move') !!}',
            product_by_package: '{!! \App\CusstomPHP\CustomURL::routeApi('get-products-by-package') !!}',
            product_import: '{!! \App\CusstomPHP\CustomURL::routeApi('product-import') !!}',
            product_return: '{!! \App\CusstomPHP\CustomURL::routeApi('product-return') !!}',
            product_return_import: '{!! \App\CusstomPHP\CustomURL::routeApi('product-return-import') !!}',
            invoices: '{!! \App\CusstomPHP\CustomURL::routeApi('invoices') !!}',
            branches: '{!! \App\CusstomPHP\CustomURL::routeApi('branches') !!}',
            finance_cat: '{!! \App\CusstomPHP\CustomURL::routeApi('finance-cat') !!}',
            customer_cat: '{!! \App\CusstomPHP\CustomURL::routeApi('customer-cat') !!}',
            customers: '{!! \App\CusstomPHP\CustomURL::routeApi('customers') !!}',
            product_cat: '{!! \App\CusstomPHP\CustomURL::routeApi('product-cat') !!}',
            suppliers: '{!! \App\CusstomPHP\CustomURL::routeApi('suppliers') !!}',
            users: '{!! \App\CusstomPHP\CustomURL::routeApi('users') !!}',
            levels_user: '{!! \App\CusstomPHP\CustomURL::routeApi('users-levels') !!}',
            current_user: '{!! \App\CusstomPHP\CustomURL::routeApi('users-information') !!}',
            select: '{!! \App\CusstomPHP\CustomURL::routeApi('select') !!}',
            check: '{!! \App\CusstomPHP\CustomURL::routeApi('check') !!}',
            settings: '{!! \App\CusstomPHP\CustomURL::routeApi('settings') !!}',
            login: '{!! \App\CusstomPHP\CustomURL::routeApi('login') !!}',
            sale: '{!! \App\CusstomPHP\CustomURL::routeApi('sale') !!}',
            update_product_invoice: '{!! \App\CusstomPHP\CustomURL::routeApi('update-product-invoice') !!}',
            stream_get: '{!! \App\CusstomPHP\CustomURL::routeApiParameters('stream-get',['name'=>'']) !!}',
            stream_set: '{!! \App\CusstomPHP\CustomURL::routeApiParameters('stream-set',['name'=>'']) !!}',
            permissions: '{!! \App\CusstomPHP\CustomURL::routeApi('permissions') !!}',
            user_roles: '{!! \App\CusstomPHP\CustomURL::routeApi('user-roles') !!}',
            finance: '{!! \App\CusstomPHP\CustomURL::routeApi('finance') !!}',
            upload_image: '{!! \App\CusstomPHP\CustomURL::route('upload-image') !!}',
            product_data: '{!! \App\CusstomPHP\CustomURL::routeApi('product-data') !!}',
            product_import_self_produced: '{!! \App\CusstomPHP\CustomURL::routeApi('product-import-self-produced') !!}',
        },
        url_logout: '{!! \App\CusstomPHP\CustomURL::route('logout') !!}',
    };
    var views = {
    ...
    function createGuiMain() {
        ...
        $("#jqxLoader").jqxLoader({text: "@lang('lang.loadding')...", isModal: true, width: 100, height: 60, imagePosition: 'top'});
...
@include('page.main.router')
@include('page.main.location_VI')
@include('page.main.const_data')